...
import { Gauge, BookOpen, BarChart3, ArrowUpRight } from "lucide-react"
...
export function FeatureSections() {
  ...
  const sections = [
    { id: "confidence", icon: Gauge, ...t.features.confidence },
    { id: "knowledge", icon: BookOpen, ...t.features.knowledge },
    { id: "probability", icon: BarChart3, ...t.features.probability },
  ]
