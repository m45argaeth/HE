...
import { randomExample } from "@/lib/hallucinations"
...
export function Hero() {
  ...
  const handleRandom = () => {
    const question = randomExample()
    window.location.href = `/playground?question=${encodeURIComponent(question)}`
  }
